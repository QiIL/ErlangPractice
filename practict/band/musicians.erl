...
firstnames() ->
    ["Valerie", "Arnold", "Carlos", "Dorothy", "Keesha", "Phoebe",
    "Ralphie", "Tim", "Wanda", "Janet"].
...
terminate(shutdown, S) ->
    io:format("The manager is mad and fire the whole band!"
              "~s just got back to playing the subway~n", [S#state.name]);
terminate(_Reason, S) ->
